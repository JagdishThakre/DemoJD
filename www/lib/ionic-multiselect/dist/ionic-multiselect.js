(function() {
    ...
    angular.module("ionic-multiselect", [])
         ...
         *   </multiselect>
         */
        .directive("multiselect", ["$ionicModal", "multiselect","$rootScope", function($ionicModal, multiselect,$rootScope) {
            return {
                restrict: "E",
                ...
                link: function(scope, element, attrs) {
                    ...
                    console.log("attrs.textProperty",attrs.textProperty);
                    ...
                    scope.getItemText = function(item) {
                        console.log("sgvg", item);
                        console.log("scope.textProperty", scope.textProperty);
                    ...
                    $rootScope.$on("callValidate", function() {
                       scope.validate();
                    });
